...
const nav: NavItem[] = [
  ...
  { label: "异常管理", href: "/anomalies", icon: "!" }, { label: "隐患管理", href: "/hazards", icon: "◆" }, { label: "我的整改任务", href: "/rectifications", icon: "↺" }, { label: "EHS 复查", href: "/reviews", icon: "◎" }, { label: "检查模板", href: "/templates", icon: "▤" }, { label: "用户与权限", href: "/users", icon: "♙" },
];
const titles: Record<string, string> = { dashboard: "首页看板", devices: "设备台账", "inspection-tasks": "我的点检任务", scan: "扫码点检", anomalies: "异常管理", hazards: "隐患管理", rectifications: "我的整改任务", reviews: "EHS 复查", templates: "检查模板管理", users: "用户与权限" };
