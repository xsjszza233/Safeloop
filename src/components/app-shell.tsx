...
const nav: NavItem[] = [
  ...
  { label: "异常管理", href: "/abnormal-records", icon: "!" }, { label: "隐患管理", href: "/hazard-records", icon: "◆" }, { label: "EHS 工作台", href: "/ehs-workbench", icon: "◎" }, { label: "我的整改任务", href: "/rectifications", icon: "↺" }, { label: "检查模板", href: "/templates", icon: "▤" }, { label: "用户与权限", href: "/users", icon: "♙" },
];
const titles: Record<string, string> = { "": "首页看板", dashboard: "首页看板", devices: "设备台账", "inspection-tasks": "我的点检任务", scan: "扫码点检", "abnormal-records": "异常管理", anomalies: "异常管理", "hazard-records": "隐患管理", hazards: "隐患管理", "ehs-workbench": "EHS 工作台", rectifications: "我的整改任务", templates: "检查模板管理", users: "用户与权限" };
